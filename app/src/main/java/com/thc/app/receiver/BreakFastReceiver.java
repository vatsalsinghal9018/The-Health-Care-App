...
//        processIt(context);
    ...
    public static void processIt(Context context) {
        ...
        do {
            ...
            if(new DataPreference(context).getBreakFast()!=null)
                DinnerReceiver.sendNotification("BREAKFAST", context);
            else
                sendNotification("BREAKFAST",context);
    ...
    public static void sendNotification(String meal, Context context) {
        ...
        if (new AppSharedPreference(context).isLoggedIn()) {
            ...
            Notification noti = new Notification.Builder(context)
                    ...
                    .setContentText("You have not had your "+meal.toLowerCase()+" yet").setSmallIcon(R.drawable.ic_launcher)
